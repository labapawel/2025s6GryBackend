export class Client {
    ...
    akcjaGracza(userId, id){
        ...
        if(this.Client1 == userId)
        {
            ...
            console.log(this.stanGry.ruchyGracza1);
            
            this.stanGry.ruchyGracza1[id].selected = true;
            if(this.stanGry.stanGracza2[id] && this.stanGry.stanGracza2[id].ship) { // sprawdzenie czy pole jest już zaznaczone
                this.stanGry.ruchyGracza2[id].shipItem.bullseye = true; // jeśli tak to ustawiamy bullseye
            }

        } else if(this.Client2 == userId) { 

            console.log(this.stanGry.ruchyGracza2);
            this.stanGry.ruchyGracza2[id].selected = true;
            if(this.stanGry.stanGracza1[id] && this.stanGry.stanGracza1[id].ship) { // sprawdzenie czy pole jest już zaznaczone
                this.stanGry.ruchyGracza1[id].shipItem.bullseye = true; // jeśli tak to ustawiamy bullseye
            }
        }
    } 
